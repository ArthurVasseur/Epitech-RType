...
namespace System
{
    ...
    MainMenu::MainMenu(std::shared_ptr<EventHandler> handler, Registry &r, const std::string &addr, short port, World &world) : _tcpClient(std::make_unique<Network::TCP::TcpClient>(addr, port)), _world(world), _handler(handler), _addr(addr)
    {
        loadMainMenu(r);
    }

    void MainMenu::update(float deltaTime, Registry &r)
    {
        try
        {
    ...
    void MainMenu::newEntity(Registry &r, Network::UDP::Command cmd, const Network::UDP::NetworkedComponent &udpComp)
    {
    ...
    void MainMenu::setEntitySprite(Registry &r, Network::UDP::Command cmd, Entity newEntity)
    {
    ...
    void MainMenu::loadGame(Registry &r, short port)
    {
        _tcpClient.reset();
        r.clear();
        ...
        auto btnBackToMainMenuEntity = r.addEntity();
        r.emplaceComponent<Component::Transform>(btnBackToMainMenuEntity, Component::Transform(Component::Vector2Df(1200, 25), 0, Component::Vector2Df(0.25f, 1)));
        r.emplaceComponent<Component::ui::Button>(btnBackToMainMenuEntity, Component::ui::Button([&r, this]()
                                                                                                 { this->onBackToMainMenu(r); },
                                                                                                 []() {}, []() {}));
        r.emplaceComponent<Component::Rectangle>(btnBackToMainMenuEntity, Component::Vector2Df(256, 43));
        ...
        r.emplaceComponent<Component::Sprite>(btnBackToMainMenuEntity, btnSprite2);
    ...
    void MainMenu::stepUpdate(float deltaTime, Registry &r)
    {
    }

    void MainMenu::onJoinById(Entity entity, Registry &r)
    {
        try
        {
            auto &txt = r.getComponent<Component::ui::Text>(entity);
    ...
    void MainMenu::loadMainMenu(Registry &r)
    {
        ...
        r.emplaceComponent<Component::ui::Button>(btnCreateLobbyEntity, Component::ui::Button(
                                                                            std::bind(&MainMenu::onCreateLobby, this), []() {}, []() {}));
    ...
    void MainMenu::onBackToMainMenu(Registry &r)
    {
        r.clear();
        System::Background::loadBackground(r);
    ...
    void MainMenu::loadLobby(Registry &r, short port)
    {
        ...
        r.emplaceComponent<Component::ui::Button>(btnCreateLobbyEntity, Component::ui::Button(
                                                                            std::bind(&MainMenu::onStartGame, this), []() {}, []() {}));
        r.emplaceComponent<Component::Rectangle>(btnCreateLobbyEntity, Component::Vector2Df(256, 43));
        auto btnSprite1 = Component::Sprite("./assets/Btn.png");
        r.emplaceComponent<Component::Sprite>(btnCreateLobbyEntity, btnSprite1);
        ...
        auto btnBackToMainMenuEntity = r.addEntity();
        r.emplaceComponent<Component::Transform>(btnBackToMainMenuEntity, Component::Transform(Component::Vector2Df(800, 500), 0, Component::Vector2Df(1, 1)));
        r.emplaceComponent<Component::ui::Button>(btnBackToMainMenuEntity, Component::ui::Button([&r, this]()
                                                                                                 { this->onBackToMainMenu(r); },
                                                                                                 []() {}, []() {}));
        r.emplaceComponent<Component::Rectangle>(btnBackToMainMenuEntity, Component::Vector2Df(256, 43));
        auto btnSprite2 = Component::Sprite("./assets/Btn.png");
        r.emplaceComponent<Component::Sprite>(btnBackToMainMenuEntity, btnSprite2);
        r.emplaceComponent<Component::ui::Text>(btnBackToMainMenuEntity, Component::ui::Text(std::string("./assets/pixelated.ttf"), std::string("       BTTMM"), Component::ui::Color(0, 0, 0), 30));
